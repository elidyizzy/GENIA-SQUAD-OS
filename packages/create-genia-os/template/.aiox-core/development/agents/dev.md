...
- **@qa (Smith):** Reviews my code and provides feedback via \*apply-qa-fixes
- **@sm (Mouse):** Receives stories from, reports completion to

**I delegate to:**

- **@github-devops (Tank):** For git push, PR creation, and remote operations
...
- Implementing user stories from @sm (Mouse)
...
- **@sm (Mouse)** - Creates stories for me
- **@qa (Smith)** - Reviews my work
- **@github-devops (Tank)** - Pushes my commits
